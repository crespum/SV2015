...
#define TEMBOO_ACCOUNT "imagine2015"  // your Temboo account name 
#define TEMBOO_APP_KEY_NAME "myFirstApp"  // your Temboo app key name
#define TEMBOO_APP_KEY  "eda1a90176a64fb3acf8ab7e1a677264"  // your Temboo app key

// Note that for additional security and reusability, you could
// use #define statements to specify these values in a .h file.

const String GOOGLE_CLIENT_ID = "625074066374-nhkpl6b2vfbc6bea8288i12q8vc37dph.apps.googleusercontent.com";
const String GOOGLE_CLIENT_SECRET = "FAxa_1S2IzFtLMmc1JBhjGs4";
const String GOOGLE_REFRESH_TOKEN = "ya29.tQEFrgBR5p3Z3Kd91OgW1XfVNceggVkbFbwYiCQp0YecgakvB1xmu0a-Dtv2S1uLQ_Ac";
...
// as described above.)
const String SPREADSHEET_TITLE = "test_yun";
...
void loop()
{
  ...
  if (numRuns <= maxRuns) {
    ...
    Serial.println("Leyendo del BLE Node...");
    ...
    */
    ...
    Serial.println("Añado valor a la spreadsheet...");
